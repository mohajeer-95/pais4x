              ...
              <div className="sidebar__categorie" style={{ marginBottom: 30 }}>
                ...
                {statebuttonText ?
                  <p>
                    ...
                    <p style={{ paddingBottom: 15 }}>
                      5.	100% refund through cashback: Through our Paid2Trade program, you gain money with every trade you close. This can be used to refund any & all fees paid for our courses, whether they were Udemy courses, or VIP training. To enroll in the Paid2Trade program.
                    </p>
                    <p style={{ paddingBottom: 15 }}>
