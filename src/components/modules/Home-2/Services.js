        ...
        <div className="service__wrapper">
          <div className="row g-4 align-items-center">
            <div className="col-sm-6 col-md-6 col-lg-4">
              <div className="service__item service__item--style2" data-aos="fade-up" data-aos-duration="800">
                <div className="service__item-inner text-center">
                  <div className="service__item-thumb mb-30">
                    <div className="service__thumb-inner">
                      <img className="dark" src="/images/service/1.png" alt="service-icon" />
                    </div>
                  </div>
            ...
            <div className="col-sm-6 col-lg-4">
              <div className="service__item service__item--style2" data-aos="fade-up" data-aos-duration="1000">
                <div className="service__item-inner text-center">
                  <div className="service__item-thumb mb-30">
                    <div className="service__thumb-inner">
                      <img className="dark" src="/images/service/2.png" alt="service-icon" />
                    </div>
                  </div>
                  <div className="service__content">
                    <h5 className="mb-15"> <Link className="stretched-link" href="service-details"> Financial Advisory</Link> </h5>
            ...
            <div className="col-sm-6 col-lg-4">
              <div className="service__item service__item--style2" data-aos="fade-up" data-aos-duration="1200">
                <div className="service__item-inner text-center">
                  <div className="service__item-thumb mb-30">
                    <div className="service__thumb-inner">
                      <img className="dark" src="/images/service/3.png" alt="service-icon" />
                    </div>
                  </div>
                  <div className="service__content">
                    <h5 className="mb-15"> <Link className="stretched-link" href="service-details">Management</Link> </h5>
            ...
            <div className="col-sm-6 col-lg-4">
              <div className="service__item service__item--style2" data-aos="fade-up" data-aos-duration="800">
                <div className="service__item-inner text-center">
                  <div className="service__item-thumb mb-30">
                    <div className="service__thumb-inner">
                      <img className="dark" src="/images/service/4.png" alt="service-icon" />
                    </div>
                  </div>
                  <div className="service__content">
                    <h5 className="mb-15"> <Link className="stretched-link" href="service-details">Supply Optimization </Link>
                    </h5>
            ...
            <div className="col-sm-6 col-lg-4">
              <div className="service__item service__item--style2" data-aos="fade-up" data-aos-duration="1000">
                <div className="service__item-inner text-center">
                  ...
                  <div className="service__content">
                    <h5 className="mb-15"> <Link className="stretched-link" href="service-details">HR consulting</Link> </h5>
