                  ...
                  <div className="footer__links">
                    ...
                    <div className="footer__links-content">
                      <ul className="footer__linklist">
                        ...
                        <li className="footer__linklist-item">
                          {" "}
                          <Link scroll={false} href="">Features</Link>
                        </li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div className="footer__links">
                    ...
                    <div className="footer__links-content">
                      <ul className="footer__linklist">
                        <li className="footer__linklist-item">
                          {" "}
                          <Link scroll={false} href="">Terms & Conditions</Link>
                        </li>
                        <li className="footer__linklist-item">
                          {" "}
                          <Link scroll={false} href="">Privacy Policy</Link>
                        </li>
                        <li className="footer__linklist-item">
                          {" "}
                          <Link scroll={false} href="">FAQs</Link>
                        </li>
                        <li className="footer__linklist-item">
                          {" "}
                          <Link scroll={false} href="">Support Center</Link>{" "}
                        </li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div className="footer__links">
                    ...
                    <div className="footer__links-content">
                      <ul className="footer__linklist">
                        <li className="footer__linklist-item">
                          {" "}
                          <Link scroll={false} href="">Careers</Link>
                        </li>
                        <li className="footer__linklist-item">
                          {" "}
                          <Link scroll={false} href="">Updates</Link>
                        </li>
                        <li className="footer__linklist-item">
                          {" "}
                          <Link scroll={false} href="">Job</Link>{" "}
                        </li>
                        <li className="footer__linklist-item">
                          {" "}
                          <Link scroll={false} href="">Announce</Link>
                        </li>
                      </ul>
                    </div>
                  </div>
