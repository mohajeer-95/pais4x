    ...
    <div className="container">
      <div className="cta__wrapper">
        <div className="cta__newsletter justify-content-center">
          <div className="cta__newsletter-inner cta__newsletter-inner--style2" data-aos="fade-up" data-aos-duration="1000">
            ...
            <div className="cta__subscribe">
              ...
              <p>mmmmmHey! Are you tired of missing out on our updates? Subscribe to our news now and stay in the loop!</p>
