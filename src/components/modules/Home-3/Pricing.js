...
const Pricing = ()=>{
    return(
<section className="pricing padding-top padding-bottom bg--cover" style={{ backgroundImage: 'url(/images/pricing/bg.png)' }}>
      ...
      <div className="pricing__shape">
        <span className="pricing__shape-item pricing__shape-item--5"> <img src="/images/icon/shape/3.png"
            alt="shape-icon"/></span>
        <span className="pricing__shape-item pricing__shape-item--6"> <img src="/images/icon/shape/1.png"
            alt="shape-icon"/>
        </span>
      </div>
    </section>
