    ...
    <section className="blog padding-top padding-bottom bg-color">
      <div className="blog__bg">
        <div className="blog__bg-element">
          <img src="/images/blog/bg.png" alt="section-bg-element" className="dark" />
        </div>
      </div>
        ...
        <div className="section-header d-md-flex align-items-center justify-content-between">
          ...
          <div className="section-header__action">
            <div className="swiper-nav swiper-nav--style1">
              <button className="swiper-nav__btn blog__slider-prev" onClick={() => swiperRef.current.slidePrev()}>
                <i className="fa-solid fa-angle-left"></i>
              </button>
              <button className="swiper-nav__btn blog__slider-next active" onClick={() => swiperRef.current.slideNext()}>
