    ...
    <>
      <footer className="footer brand-1">
        ...
        <div className="footer__shape">
          ...
          <span className="footer__shape-item footer__shape-item--4"><img src="/images/icon/shape/2.png"
            alt="shape icon" /></span>
          <span className="footer__shape-item footer__shape-item--5"><img src="/images/icon/shape/1.png"
            alt="shape icon" /></span>
        </div>
      </footer>
      <ScrollToTop
