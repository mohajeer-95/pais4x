    ...
    <div className="container">
      <div className="cta__wrapper">
            ...
            <div className="cta__subscribe">
              ...
              <form className="cta-form cta-form--style2 form-subscribe" action="">
                <div className="cta-form__inner d-sm-flex align-items-center">
                  ...
                  <button className="trk-btn  trk-btn--large trk-btn--secondary2" type="submit">Submit</button>
                </div>
              </form>
            </div>
          </div>
        ...
        <div className="cta__shape">
          <span className="cta__shape-item cta__shape-item--1"><img src="/images/cta/2.png" alt="shape icon"/></span>
          <span className="cta__shape-item cta__shape-item--2"><img src="/images/cta/4.png" alt="shape icon"/></span>
          <span className="cta__shape-item cta__shape-item--3"><img src="/images/cta/5.png" alt="shape icon"/></span>
        </div>
      </div>
    </div>
  </section>
